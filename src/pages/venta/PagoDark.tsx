              ...
              <div class="lg:col-span-8 space-y-8">
                <section class="bg-zinc-900/60 border border-white/5 p-8 rounded-xl shadow-sm">
                  ...
                  <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
                    ...
                    <button class="bg-zinc-900/40 group flex flex-col items-center justify-center p-8 rounded-xl border-2 border-transparent transition-all hover:bg-zinc-900 hover:border-white/5">
