    ...
    <div className="font-display transition-colors duration-300 bg-creme text-primary">
      <div className="layout-container flex h-full grow flex-col min-h-screen">
        ...
        <main className="flex flex-col" dangerouslySetInnerHTML={{ __html: `
          <section class="bg-primary text-creme py-16 px-6 lg:px-20 border-b border-white/10">
            <div class="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-end gap-8">
              <div>
                ...
                <p class="text-creme/60 font-medium">Código de Reserva: <span class="text-creme">AV-9428510</span></p>
              </div>
              <div class="flex gap-4 w-full md:w-auto">
                ...
                <button class="flex-1 md:flex-none border border-creme/20 hover:bg-white/10 text-creme px-8 py-4 rounded text-xs font-black uppercase tracking-widest transition-all">
                  Descargar PDF
                </button>
              </div>
            </div>
          </section>
          <section class="py-20 px-6 lg:px-20 bg-creme">
            <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-12">
              <div class="lg:col-span-2 space-y-12">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-px bg-primary/10 border border-primary/10 overflow-hidden rounded-lg">
                ...
                <div class="space-y-4">
                  <details class="group bg-white/40 border border-primary/5 rounded-lg overflow-hidden" open="">
                    <summary class="flex items-center justify-between p-6 cursor-pointer hover:bg-primary/5 transition-all" style="list-style: none;">
                    ...
                    <div class="p-8 pt-0 grid grid-cols-1 md:grid-cols-2 gap-8">
                      <div>
                        <p class="text-xs font-black text-muted uppercase tracking-widest mb-4">Tipo de Habitación</p>
                        <p class="font-bold text-lg text-primary mb-4">Suite Ejecutiva con Vista al Jardín</p>
                        <ul class="space-y-3">
                          <li class="flex items-center gap-3 text-sm text-primary/70">
                      ...
                      <div class="bg-primary/5 rounded p-6">
                        <p class="text-xs font-black text-muted uppercase tracking-widest mb-4">Servicios Incluidos</p>
                        <div class="grid grid-cols-2 gap-4">
                          <div class="flex flex-col gap-1">
                            <span class="material-symbols-outlined text-primary/60">wifi</span>
                            <span class="text-[10px] font-bold uppercase text-primary/60">Wi-Fi 6</span>
                          </div>
                          <div class="flex flex-col gap-1">
                            <span class="material-symbols-outlined text-primary/60">coffee_maker</span>
                            <span class="text-[10px] font-bold uppercase text-primary/60">Nespresso</span>
                          </div>
                          <div class="flex flex-col gap-1">
                            <span class="material-symbols-outlined text-primary/60">ac_unit</span>
                            <span class="text-[10px] font-bold uppercase text-primary/60">Clima Smart</span>
                          </div>
                          <div class="flex flex-col gap-1">
                            <span class="material-symbols-outlined text-primary/60">tv</span>
                            <span class="text-[10px] font-bold uppercase text-primary/60">Smart TV 55"</span>
                          </div>
                        </div>
                      </div>
                    </div>
                  </details>
                  <details class="group bg-white/40 border border-primary/5 rounded-lg overflow-hidden">
                    <summary class="flex items-center justify-between p-6 cursor-pointer hover:bg-primary/5 transition-all" style="list-style: none;">
                      <div class="flex items-center gap-4">
                    ...
                    <div class="p-8 pt-0 space-y-6">
                      ...
                      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="border border-primary/10 p-4 rounded">
                          <p class="text-xs font-black text-primary uppercase mb-2">Restaurante Aviro</p>
                          <p class="text-xs text-muted mb-4">Cocina de autor e internacional</p>
                          <button class="text-[10px] font-black text-secondary uppercase tracking-widest">Reservar mesa</button>
                        </div>
                        <div class="border border-primary/10 p-4 rounded">
                          <p class="text-xs font-black text-primary uppercase mb-2">Room Service</p>
                          <p class="text-xs text-muted mb-4">Disponible las 24 horas</p>
                ...
                <div class="pt-12 border-t border-primary/10">
                  <h2 class="text-2xl font-black text-primary tracking-tighter mb-8">Preguntas Frecuentes para tu Estadía</h2>
                  <div class="space-y-6">
                    <div>
                      <h4 class="font-bold text-primary mb-2">¿Puedo solicitar un Late Check-out?</h4>
                      <p class="text-sm text-muted leading-relaxed">Sujeto a disponibilidad. Se puede solicitar en recepción el día de la salida. Los miembros Elite disfrutan de late check-out garantizado hasta las 14:00.</p>
                    </div>
                    <div>
                      <h4 class="font-bold text-primary mb-2">¿Cómo funciona el acceso al Parking?</h4>
                      <p class="text-sm text-muted leading-relaxed">Tu reserva incluye parking gratuito. Al llegar, simplemente escanea el código QR de tu reserva en la entrada del estacionamiento subterráneo.</p>
                    </div>
                    <div>
                      <h4 class="font-bold text-primary mb-2">¿Tienen servicio de transfer al aeropuerto?</h4>
                      <p class="text-sm text-muted leading-relaxed">Sí, contamos con shuttles cada 30 minutos. Puedes coordinar tu recogido o salida directamente desde el botón de "Contactar Soporte".</p>
                    </div>
                  </div>
                </div>
              </div>
              <aside class="space-y-8">
                <div class="bg-primary p-8 rounded-lg text-creme">
                  ...
                  <ul class="space-y-6">
                    <li class="flex gap-4">
                      ...
                      <div>
                        ...
                        <p class="text-xs text-creme/60 leading-relaxed">Se requiere una tarjeta de crédito válida al check-in para gastos incidentales.</p>
                      </div>
                    </li>
                    <li class="flex gap-4">
                      ...
                      <div>
                        ...
                        <p class="text-xs text-creme/60 leading-relaxed">Se permiten mascotas de hasta 15kg previa notificación (cargo adicional aplica).</p>
                      </div>
                    </li>
                    <li class="flex gap-4">
                      ...
                      <div>
                        ...
                        <p class="text-xs text-creme/60 leading-relaxed">Todas nuestras habitaciones y áreas comunes son 100% libres de humo.</p>
                      </div>
                    </li>
                  </ul>
                </div>
                <div class="bg-white p-8 border border-primary/10 rounded-lg shadow-sm">
                  <h3 class="text-xs font-black text-primary uppercase tracking-[0.2em] mb-6">Asistencia Personalizada</h3>
                  <p class="text-sm text-muted mb-8 leading-relaxed">¿Necesitas algún requerimiento especial o tienes dudas sobre tu llegada?</p>
                  <button class="w-full bg-primary hover:opacity-90 text-creme py-4 rounded text-xs font-black uppercase tracking-widest transition-all flex items-center justify-center gap-3">
                    <span class="material-symbols-outlined text-lg">headset_mic</span>
                    Contactar Soporte
                  </button>
                  <div class="mt-6 pt-6 border-t border-primary/5 flex items-center justify-center gap-4 text-primary/40">
