            ...
            <div class="mb-16">
              <div class="flex items-center justify-between max-w-2xl mx-auto relative">
                ...
                <div class="relative z-10 flex flex-col items-center gap-3">
                  ...
                  <span class="text-[10px] font-black uppercase tracking-widest text-primary/60">Huésped</span>
                </div>
                <div class="relative z-10 flex flex-col items-center gap-3">
              ...
              <div class="lg:col-span-8 space-y-8">
                <section class="bg-white/60 border border-primary/5 p-8 rounded-xl shadow-sm">
                  ...
                  <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
                    ...
                    <button class="bg-white/40 group flex flex-col items-center justify-center p-8 rounded-xl border-2 border-transparent transition-all hover:bg-white hover:border-primary/10">
                      <div class="size-16 rounded-full bg-primary/5 flex items-center justify-center text-primary/40 mb-4 group-hover:scale-110 transition-transform">
                        <span class="material-symbols-outlined text-3xl">account_balance</span>
                      </div>
                      <span class="text-xs font-black uppercase tracking-[0.2em] text-primary/60">PayPal</span>
                  ...
                  <div class="space-y-8 animate-in fade-in slide-in-from-top-4 duration-500">
                    <div class="bg-white p-8 rounded-xl border border-primary/10">
                      <h3 class="text-[10px] font-black uppercase tracking-[0.2em] text-secondary mb-8">Detalles de la Tarjeta</h3>
                      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="md:col-span-2 space-y-2">
                          <label class="text-[10px] font-black uppercase tracking-widest text-muted">Nombre en la Tarjeta</label>
                          <input class="w-full bg-creme/30 border-primary/10 rounded px-4 py-3 text-sm font-bold text-primary placeholder:text-primary/20" placeholder="Como figura en el plástico" type="text"/>
                        </div>
                        <div class="md:col-span-2 space-y-2">
                          <label class="text-[10px] font-black uppercase tracking-widest text-muted">Número de Tarjeta</label>
                          <div class="relative">
                            <input class="w-full bg-creme/30 border-primary/10 rounded px-4 py-3 text-sm font-bold text-primary tracking-widest" placeholder="0000 0000 0000 0000" type="text"/>
                        ...
                        <div class="space-y-2">
                          <label class="text-[10px] font-black uppercase tracking-widest text-muted">Fecha de Expiración</label>
                          <input class="w-full bg-creme/30 border-primary/10 rounded px-4 py-3 text-sm font-bold text-primary" placeholder="MM/YY" type="text"/>
                        </div>
                        <div class="space-y-2">
                          <label class="text-[10px] font-black uppercase tracking-widest text-muted">CVV / CVC</label>
                          <input class="w-full bg-creme/30 border-primary/10 rounded px-4 py-3 text-sm font-bold text-primary" placeholder="123" type="password"/>
                        </div>
                      </div>
                      <div class="mt-8 p-4 bg-primary/5 rounded border border-primary/5 flex items-center gap-4">
                        <span class="material-symbols-outlined text-primary/40">lock</span>
                        <p class="text-[10px] font-medium text-primary/60">Sus datos de pago se procesan de forma segura mediante encriptación SSL de 256 bits. Nosotros no almacenamos los datos de su tarjeta.</p>
                      </div>
                    </div>
                  </div>
                  <div class="mt-8 pt-8 border-t border-primary/10">
                    <div class="flex items-center justify-between text-[11px] font-black uppercase tracking-wider text-muted mb-4">
                      <span>Recordatorio de Reserva</span>
                      <a class="text-secondary hover:underline" href="#">Editar</a>
                    </div>
                    <div class="flex items-center gap-3 p-4 bg-creme/30 rounded border border-primary/5">
                      <span class="material-symbols-outlined text-primary/40 text-lg">calendar_today</span>
                      <p class="text-[10px] font-bold text-primary/70 uppercase tracking-tight">Registro para 2 Habitaciones · 3 Huéspedes · Check-in 15:00</p>
                    </div>
                  </div>
                </section>
                <div class="flex flex-col sm:flex-row justify-between items-center gap-6 pt-4">
                  ...
                  <button class="w-full sm:w-auto bg-primary text-creme px-12 py-5 rounded-lg text-[11px] font-black uppercase tracking-[0.2em] hover:opacity-95 transition-all shadow-xl shadow-primary/20 flex items-center justify-center gap-4 group">
