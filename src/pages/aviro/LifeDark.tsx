﻿
export default function LifeDark() {
  return (
        ...
        <main className="flex flex-col" dangerouslySetInnerHTML={{ __html: `
          <section class="relative pt-20 pb-32 px-6 lg:px-20 overflow-hidden">
            <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center xl:gap-24">
              <div class="lg:col-span-5 z-10">
                ...
                <h1 class="font-serif text-6xl lg:text-8xl text-zinc-100 leading-tight mb-8">El arte de pertenecer.</h1>
                ...
                <button class="bg-zinc-900 text-zinc-100 px-10 py-4 text-xs font-bold uppercase tracking-widest hover:bg-opacity-90 transition-all">
                  Únete al Círculo
                </button>
              </div>
              <div class="lg:col-span-7 relative">
                ...
                <div class="absolute -bottom-10 -left-10 bg-secondary p-8 hidden lg:block max-w-xs">
                  <p class="text-zinc-100 text-sm font-medium italic">"La verdadera exclusividad no es el lujo, sino el reconocimiento de sus preferencias antes de que las mencione."</p>
                </div>
              </div>
            </div>
          </section>
          <section class="py-32 bg-zinc-900 border-y border-white/5">
            <div class="mx-auto px-6 text-center max-w-7xl">
              <h2 class="font-serif text-4xl md:text-5xl text-zinc-100 mb-12 italic">Más que noches, son momentos compartidos.</h2>
              <div class="grid grid-cols-1 md:grid-cols-3 gap-16 text-left border-t border-white/5 pt-16">
                <div>
                  <span class="text-secondary font-black text-2xl mb-4 block">01.</span>
                  <h3 class="font-bold text-lg mb-4 text-zinc-100 uppercase tracking-tighter">Fidelidad Recompensada</h3>
                  <p class="text-zinc-500 text-sm editorial-text">Cada noche con nosotros cuenta. A medida que sus estancias crecen, también lo hace nuestra gratitud, manifestándose en beneficios tangibles para su próxima reserva.</p>
                </div>
                <div>
                  <span class="text-secondary font-black text-2xl mb-4 block">02.</span>
                  <h3 class="font-bold text-lg mb-4 text-zinc-100 uppercase tracking-tighter">Gastronomía Sin Límites</h3>
                  <p class="text-zinc-500 text-sm editorial-text">Los miembros de Life disfrutan de una mesa siempre reservada y descuentos exclusivos en nuestro restaurante de autor, celebrando el paladar en cada visita.</p>
                </div>
                <div>
                  <span class="text-secondary font-black text-2xl mb-4 block">03.</span>
                  <h3 class="font-bold text-lg mb-4 text-zinc-100 uppercase tracking-tighter">Acceso Preferencial</h3>
                  <p class="text-zinc-500 text-sm editorial-text">Upgrade de habitaciones sujeto a disponibilidad y early check-in para que su experiencia comience en el momento exacto en que llega a la ciudad.</p>
                </div>
              </div>
            </div>
          </section>
          <section class="py-24 px-6 lg:px-20 bg-zinc-900">
            <div class="max-w-7xl mx-auto">
              <div class="flex flex-col lg:flex-row gap-1 border-white/5 border">
                <div class="flex-1 relative group overflow-hidden">
                  ...
                  <div class="absolute inset-0 bg-primary/40 opacity-0 group-hover:opacity-100 transition-opacity flex flex-col justify-end p-12 text-zinc-100">
          ...
          <section class="py-24 bg-zinc-900">
            <div class="max-w-7xl mx-auto px-6 lg:px-20">
              <div class="grid grid-cols-1 md:grid-cols-2 gap-24 items-center xl:gap-32">
                <div>
                  <h2 class="text-4xl font-serif text-zinc-100 mb-12">Historias de nuestro círculo.</h2>
                    ...
                    <div class="relative pl-12">
                      ...
                      <div class="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p class="text-[10px] text-zinc-500 font-bold uppercase">Miembro Horizonte desde 2021</p>
                        </div>
                      </div>
                    </div>
                    <div class="relative pl-12">
                      ...
                      <div class="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p class="text-[10px] text-zinc-500 font-bold uppercase">Miembro Infinito</p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="relative">
                  ...
                  <div class="absolute -top-10 -right-10 w-48 h-48 bg-zinc-900 flex items-center justify-center p-8 text-center">
                    <p class="text-zinc-100 text-xs font-bold uppercase tracking-widest leading-loose">Descubre el privilegio de ser parte.</p>
                  </div>
                </div>
              </div>
            </div>
          </section>
          <section class="py-24 bg-zinc-900 text-zinc-100">
            <div class="max-w-4xl mx-auto px-6 text-center">
              ...
              <p class="text-zinc-400 text-lg mb-12 max-w-2xl mx-auto editorial-text">Comience su camino en Life hoy mismo. Regístrese y obtenga beneficios inmediatos en su primera reserva a través de nuestra web.</p>
              <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <button class="bg-secondary text-zinc-100 px-12 py-5 text-xs font-black uppercase tracking-widest hover:opacity-90 transition-all">Registrarse Ahora</button>
                <button class="border border-creme/20 text-zinc-100 px-12 py-5 text-xs font-black uppercase tracking-widest hover:bg-zinc-900/10 transition-all">Ver Más Beneficios</button>
              </div>
            </div>
          </section>
        `}} />
