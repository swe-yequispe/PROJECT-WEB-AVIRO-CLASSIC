    ...
    <div className="font-display bg-creme text-primary">
      <div className="layout-container flex h-full grow flex-col min-h-screen">
        <header className="sticky top-0 z-50 bg-creme/95 backdrop-blur-md border-b border-primary/10 px-6 lg:px-12 py-4 xl:px-20">
          <div className="flex items-center justify-between max-w-7xl mx-auto">
            ...
            <div className="flex items-center gap-3">
              ...
              <button className="hidden sm:flex items-center justify-center rounded px-5 h-9 bg-primary text-creme text-xs font-bold uppercase tracking-widest hover:opacity-90 transition-all shadow-sm">
                Reservar ahora
              </button>
        ...
        <main className="flex flex-col" dangerouslySetInnerHTML={{ __html: `
          <section class="relative min-h-[calc(100vh-88px)] flex flex-row overflow-hidden border-b border-primary/10 bg-creme"><aside class="hidden lg:flex flex-col w-[400px] bg-primary border-r border-primary/10 z-40 p-12 shrink-0">
            <div class="booking-sidebar w-full">
              <div class="mb-10">
                ...
                <h3 class="text-3xl font-black text-creme leading-tight tracking-tighter">Reserva con tu Tarifa Preferencial</h3>
              </div>
              <div class="space-y-6">
                <div class="flex flex-col gap-2">
                  <label class="text-[10px] font-bold text-creme/60 uppercase tracking-wider">Código de Empresa</label>
                  <input class="w-full bg-white/10 border border-white/20 rounded p-4 text-sm text-creme placeholder:text-creme/30 focus:border-secondary focus:ring-0 transition-all uppercase" placeholder="Ej: CORP-2024" type="text"/>
                </div>
                <div class="grid grid-cols-2 gap-4">
                  <div class="flex flex-col gap-2">
                    <label class="text-[10px] font-bold text-creme/60 uppercase tracking-wider">Llegada</label>
                    <input class="w-full bg-white/10 border border-white/20 rounded p-4 text-sm text-creme focus:border-secondary focus:ring-0 transition-all" type="date"/>
                  </div>
                  <div class="flex flex-col gap-2">
                    <label class="text-[10px] font-bold text-creme/60 uppercase tracking-wider">Salida</label>
                    <input class="w-full bg-white/10 border border-white/20 rounded p-4 text-sm text-creme focus:border-secondary focus:ring-0 transition-all" type="date"/>
                  </div>
                </div>
              ...
              <div class="mt-16 pt-8 border-t border-white/10 space-y-5">
                <div class="flex items-center gap-3 text-creme/70">
            ...
            <div class="flex-grow relative flex flex-col justify-center px-12 lg:px-24 py-24">
              ...
              <div class="relative z-20 max-w-3xl">
                <h1 class="text-primary text-5xl lg:text-8xl font-black leading-[1] tracking-tighter mb-10">
                  Tu oficina lejos de casa, con <span class="text-secondary italic">beneficios exclusivos.</span>
                </h1>
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-12">
                  <div class="bg-primary text-creme p-6 rounded-lg flex items-center gap-5 shadow-xl">
          ...
          <section class="py-24 px-6 lg:px-20 bg-creme relative">
            <div class="max-w-7xl mx-auto">
              <div class="text-center mb-20">
                <span class="text-secondary font-black uppercase tracking-[0.3em] text-[10px] mb-4 block">Propuesta de Valor</span>
                <h2 class="text-3xl md:text-5xl font-black text-primary mb-6 tracking-tighter">Membresía vs. Cliente Corporativo</h2>
                <div class="h-1.5 w-24 bg-secondary mx-auto"></div>
              </div>
              <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div class="bg-white/50 border border-primary/10 p-10 rounded-xl">
                  <h4 class="text-muted font-bold uppercase tracking-widest text-xs mb-8">Viajero Estándar</h4>
                  <ul class="space-y-6">
                    <li class="flex items-center gap-3 text-primary/60">
                ...
                <div class="bg-primary text-creme p-10 rounded-xl shadow-2xl lg:-mt-8 lg:mb-8 border-t-4 border-secondary relative overflow-hidden">
                  ...
                  <h4 class="text-creme font-bold uppercase tracking-widest text-xs mb-8">Beneficios Corporativos</h4>
                  <ul class="space-y-6">
                  ...
                  <button class="w-full mt-10 bg-secondary py-4 font-black uppercase text-xs tracking-widest rounded-lg hover:bg-white hover:text-primary transition-all">Solicitar Convenio</button>
                </div>
                <div class="bg-white/50 border border-primary/10 p-10 rounded-xl">
                  <h4 class="text-muted font-bold uppercase tracking-widest text-xs mb-8">Servicios Complementarios</h4>
                  <ul class="space-y-6">
          ...
          <section class="py-24 bg-primary/5 border-y border-primary/10">
            <div class="max-w-7xl mx-auto px-6 lg:px-20">
              <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                <div>
                  <h2 class="text-4xl font-black text-primary mb-6 tracking-tighter leading-tight">Calcula el Ahorro de tu Empresa</h2>
                  <p class="text-muted text-lg mb-10 leading-relaxed">Nuestros convenios están diseñados para optimizar el presupuesto de viajes corporativos. Más que una estadía, somos tu aliado estratégico.</p>
                  <div class="space-y-8">
                    <div class="flex items-start gap-5">
                      ...
                      <div>
                        ...
                        <p class="text-sm text-muted">Gestión simplificada de gastos con facturación electrónica inmediata a nombre de tu empresa.</p>
                      </div>
                    </div>
                    <div class="flex items-start gap-5">
                      <div class="bg-primary/10 p-3 rounded-lg text-primary">
                      ...
                      <div>
                        ...
                        <p class="text-sm text-muted">Bloqueos de habitaciones para periodos de alta demanda según contrato.</p>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="bg-white p-12 rounded-2xl shadow-xl border border-primary/5">
                  ...
                  <div class="space-y-8 mb-12">
                    <div>
                      <div class="flex justify-between text-xs font-bold uppercase text-primary mb-3">
                  ...
                  <div class="bg-primary p-8 rounded-xl text-center">
                    <p class="text-creme/60 text-[10px] font-black uppercase tracking-widest mb-2">Ahorro directo proyectado</p>
                    <p class="text-creme text-5xl font-black tracking-tighter mb-4">$4,850 <span class="text-sm font-normal text-creme/50 uppercase tracking-tighter">USD / Año</span></p>
                ...
                <div>
                  ...
                  <div class="grid grid-cols-2 gap-px bg-creme/10 border border-creme/10">
                    <div class="bg-creme/5 backdrop-blur-sm p-10">
                      ...
                      <div class="text-creme/60 text-xs font-bold uppercase tracking-widest">Empresas Aliadas</div>
                    </div>
                    <div class="bg-creme/5 backdrop-blur-sm p-10">
                      <div class="text-5xl font-black text-creme mb-2">24h</div>
                      <div class="text-creme/60 text-xs font-bold uppercase tracking-widest">Soporte Corp</div>
                    </div>
                    <div class="bg-creme/5 backdrop-blur-sm p-10">
                      <div class="text-5xl font-black text-creme mb-2">98%</div>
                      <div class="text-creme/60 text-xs font-bold uppercase tracking-widest">Tasa de Retención</div>
                    </div>
                    <div class="bg-creme/5 backdrop-blur-sm p-10">
                      <div class="text-5xl font-black text-creme mb-2">15m</div>
                      <div class="text-creme/60 text-xs font-bold uppercase tracking-widest">Cercanía Financiera</div>
                    </div>
                  </div>
                </div>
          ...
          <section class="py-24 px-6 lg:px-20 bg-creme">
            <div class="max-w-7xl mx-auto">
              <div class="text-center mb-16">
                <h2 class="text-xs font-black text-muted uppercase tracking-[0.4em] mb-4">Proceso para Empresas</h2>
                <p class="text-3xl font-black text-primary tracking-tighter">Integración inmediata sin burocracia</p>
              </div>
              <div class="grid grid-cols-1 md:grid-cols-3 gap-px bg-primary/10 border border-primary/10">
                <div class="bg-creme p-12 text-center group transition-all">
                  <div class="size-16 rounded border border-primary/10 flex items-center justify-center text-primary/40 text-xl font-black mb-8 mx-auto group-hover:bg-primary group-hover:text-creme transition-all">01</div>
                  <h4 class="text-lg font-bold text-primary mb-4">Registro Corp</h4>
                  <p class="text-muted text-sm">Tu empresa solicita el convenio digital en menos de 5 minutos.</p>
                </div>
                <div class="bg-creme p-12 text-center group transition-all">
                ...
                <div class="bg-creme p-12 text-center group transition-all">
                  <div class="size-16 rounded border border-primary/10 flex items-center justify-center text-primary/40 text-xl font-black mb-8 mx-auto group-hover:bg-primary group-hover:text-creme transition-all">03</div>
                  <h4 class="text-lg font-bold text-primary mb-4">Control Total</h4>
                  <p class="text-muted text-sm">Accede al portal administrativo para gestionar facturas y consumos.</p>
                </div>
              </div>
            </div>
          </section>
          <section class="py-16 px-6 lg:px-20 bg-primary/5 border-y border-primary/10">
            <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12">
              <h3 class="text-xs font-black uppercase tracking-[0.3em] text-muted border-l-2 border-primary pl-4">Canales de Pago Corporativos</h3>
